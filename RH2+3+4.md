...
### **<span style="color:orange">mv</span>** [ **<span style="color:red">OPTION</span>** ] [ **<span style="color:red">SOURCE_PATH</span>** ] [ **<span style="color:red">DEST_PATH</span>** ]  := Move file or directory
```shell
	-b  := backup 
